# Hướng dẫn nạp chương trình, cài đặt Extension trên MakerCode với Micro:bit và các phần cứng MakerEdu
[![Huong dan su dung micro:bit](/image/microbit.png)](https://www.youtube.com/watch?v=QjZL8yu3Uu4)

MakerLab hướng dẫn các bạn mới tìm hiểu về Micro:bit và phần cứng MakerEdu: cách nạp chương trình cho Micro:bit trên MadeCode, cách cài đặt Extension cho các phần cứng MakerEdu trên MakeCode.
- Trang chủ MadeCode: https://makecode.microbit.org/
